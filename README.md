...
Locally ran Redaction Software, runs in a docker container for easy deployment. Uses Tesseract OCR for searching and mass-redaction. (WIP)
## Supported formats
...
* Local Development tools are a bit finicky, the docker container is working better for me.
